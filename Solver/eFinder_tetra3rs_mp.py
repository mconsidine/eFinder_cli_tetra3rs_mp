...
#   cam_cmd_q      — Queue  solver -> camera: set_exp, capture_once, stop
#   cam_result_q   — Queue  camera -> solver: capture_once result
#   _maint_sock    — Unix socket  web-ui -> solver thread
